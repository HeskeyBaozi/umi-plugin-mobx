...
${IMPORT}`.trim());
    ...
    api.register('modifyRouteComponent', ({ memo, args }) => {
      ...
      <% STORES %>
            ...
            const importTarget = shouldImportDynamic ? `import(/* webpackChunkName: '${chunkName(paths.cwd, path$$1)}' */ '${pageJSFile}')` : `require(/* webpackChunkName: '${chunkName(paths.cwd, path$$1)}' */ '${pageJSFile}').default`;
